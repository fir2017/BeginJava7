public class T2 {
  public static int divide (int[] array, int index) throws ZeroDivideException, ArrayIndexOutOfBoundsByIndex{
    try {
      ...
      System.out.println("Throwing ArrayIndexOutOfBoundsIndex in divide()!"); 
      throw new ArrayIndexOutOfBoundsByIndex("Array length (" + array.length + "), but index = " + index, index, e);
    }
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < x.length; i++){
      ...
      }catch (ArrayIndexOutOfBoundsByIndex e) {
